...
parameter signed [15:0] filter1_a2 = 16'b0001_1111_1010_0100; //CSD:0010_0000_-1010_0100
parameter signed [15:0] filter1_a3 = 16'b0000_1111_1010_1100; //CSD:0001_0000_0-10-1_0-100
...
assign Ymult1 = {{1{Yin_reg[0][N-1]}},Yin_reg[0],13'd0}
              ...
              + {{9{Yin_reg[0][N-1]}},Yin_reg[0],5'd0}
              + {{12{Yin_reg[0][N-1]}},Yin_reg[0],2'd0};
//multiply by filter1_a2 = 16'b0001_1111_1010_0100;
//mutiply by 8100
//CSD:0010_0000_-1010_0100
...
//multiply by filter1_a3 = 16'b0000_1111_1010_1100;
//multiply by 4012
//CSD:0001_0000_0-10-1_0-100
