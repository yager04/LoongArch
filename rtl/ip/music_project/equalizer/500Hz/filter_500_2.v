...
parameter signed [15:0] filter1_a2 = 16'b0001_1111_1001_0001; //CSD:0010_0000_-1001_0001
parameter signed [15:0] filter1_a3 = 16'b0000_1111_1001_1100; //CSD:0001_0000_-1010_0-100
...
assign Ymult1 = {{1{Yin_reg[0][N-1]}},Yin_reg[0],13'd0}
              ...
              + {{10{Yin_reg[0][N-1]}},Yin_reg[0],4'd0}
              + {{14{Yin_reg[0][N-1]}},Yin_reg[0]};
//multiply by filter1_a2 = 16'b0001_1111_1001_0001; 
//multiply by 8081
//CSD:0010_0000_-1001_0001
...
assign Ymult2 = {{2{Yin_reg[1][N-1]}},Yin_reg[1],12'd0}
              ...
              - {{12{Yin_reg[1][N-1]}},Yin_reg[1],2'd0};
//multiply by filter1_a3 = 16'b0000_1111_1001_1100;
//multiply by 3996
//CSD:0001_0000_-1010_0-100
