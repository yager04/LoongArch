...
parameter signed [15:0] filter1_a2 = 16'b0001_1111_0011_1101; //CSD:0010_000-1_0100_0-101
parameter signed [15:0] filter1_a3 = 16'b0000_1111_0101_1011; //CSD:0001_0000_-10-10_0-10-1
...
assign Ymult1 = {{1{Yin_reg[0][N-1]}},Yin_reg[0],13'd0}
              ...
              - {{12{Yin_reg[0][N-1]}},Yin_reg[0],2'd0}
              + {{14{Yin_reg[0][N-1]}},Yin_reg[0]};
//multiply by filter1_a2 = 16'b0001_1111_0011_1101;
//mutiply by 7997
//CSD:0010_000-1_0100_0-101
/*
...
assign Ymult2 = {{2{Yin_reg[1][N-1]}},Yin_reg[1],12'd0}
              ...
              - {{14{Yin_reg[1][N-1]}},Yin_reg[1]};
//multiply by filter1_a3 = 16'b0000_1111_0101_1011;
//multiply by 3931
//CSD:0001_0000_-10-10_0-10-1
