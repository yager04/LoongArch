...
parameter signed [15:0] filter1_a2 = 16'b0001_1101_1101_1010; //CSD:0010_00-10_00-10_-1010
parameter signed [15:0] filter1_a3 = 16'b0000_1110_0111_1100; //CSD:0001_00-10_1000_0-100
...
assign Ymult1 = {{1{Yin_reg[0][N-1]}},Yin_reg[0],13'd0}
              ...
              - {{11{Yin_reg[0][N-1]}},Yin_reg[0],3'd0}
              + {{13{Yin_reg[0][N-1]}},Yin_reg[0],1'd0};
//multiply by filter1_a2 = 16'b0001_1101_1101_1010; 
//CSD:0010_00-10_00-10_-1010
...
assign Ymult2 = {{2{Yin_reg[1][N-1]}},Yin_reg[1],12'd0}
              ...
              - {{12{Yin_reg[1][N-1]}},Yin_reg[1],2'd0};
//multiply by filter1_a3 = 16'b0000_1110_0111_1100;
//CSD:0001_00-10_1000_0-100
