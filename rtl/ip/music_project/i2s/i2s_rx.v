...
reverberator u_reverberator(
	.clk(clk_48k),
	.rst_n(reset_n),
	.reverberator_En(1'b1),
	.din(reg_cic_data1),
	.dout(reverberator_out)
);
...
always @(*) begin   
	...
	4'd4:adcfifo_writedata = {reverberator_out,reverberator_out};
